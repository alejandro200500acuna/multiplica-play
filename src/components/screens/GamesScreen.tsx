...
import { ChevronLeft, Zap, CheckCircle2, Edit3, Puzzle, Trophy, Medal } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 w-full max-w-6xl mx-auto items-start">
      ...
      <motion.div 
        ...
        className="glass-panel p-6 md:p-8 rounded-3xl w-full lg:w-80 shadow-2xl border-t-4 border-t-yellow-400"
      >
