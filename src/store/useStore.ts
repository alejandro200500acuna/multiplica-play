...
export type Step = 'WELCOME' | 'MODE_SELECT' | 'TABLES' | 'GAMES' | 'PLAYING' | 'RESULTS' | 'ADMIN_DASHBOARD' | 'COMPETITION_LOBBY' | 'COMPETITION_GAME' | 'COMPETITION_RESULT' | 'LEARN_TABLES' | 'SETTINGS';
